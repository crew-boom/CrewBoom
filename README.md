...
> If you need more help than [the documentation](https://github.com/crew-boom/CrewBoom/wiki) can provide, please refer to [the Team Reptile Discord server's modding channel.](https://discord.com/invite/reptilehideout)  
...
Example:  
<img width="938" height="512" alt="image" src="https://github.com/user-attachments/assets/0b9118fe-602e-4a59-89ab-625c95637c9e" />
...
The latest download [is always available here](https://github.com/crew-boom/CrewBoom/releases)

- [How to use the plugin/project](https://github.com/crew-boom/CrewBoom/wiki)
- [Troubleshooting](https://github.com/crew-boom/CrewBoom/wiki/Troubleshooting)
> [!NOTE]
...
**Manual Install**
1. [Download the plugin](https://github.com/crew-boom/CrewBoom/releases)
...
You can find instructions on how to do this [here](https://github.com/crew-boom/CrewBoom/wiki/Character-Configuration#editing-the-json-file)
...
- Programming and Unity SDK: SoftGoat
